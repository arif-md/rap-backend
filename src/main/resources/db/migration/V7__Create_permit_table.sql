...
CREATE INDEX IDX_permit_holder_id ON permit(holder_id);

-- Create index for permit_number for faster lookups
CREATE INDEX IDX_permit_number ON permit(permit_number);
...
CREATE INDEX IDX_permit_expiry_date ON permit(expiry_date);
